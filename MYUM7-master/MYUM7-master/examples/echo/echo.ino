...
void setup() {
  ...
  // Set quaternion dataset rate
  //imu.set_quaternion_rate(115200);
...
//      Serial.print(imu.up_vel); Serial.print(", ");
    ...
    //  Serial.print(imu.quat_time); Serial.print(", ");

    //  Serial.print(asin(2 * ((imu.quat_c * imu.quat_a) - (imu.quat_b * imu.quat_d))));

      // Print all euler datasets (excluding times)
      Serial.print("Roll:"); Serial.print(imu.roll); Serial.print("\n");
      Serial.print("Pitch:"); Serial.print(imu.pitch); Serial.print("\n");
      Serial.print("Yaw:"); Serial.print(imu.yaw); //Serial.print(", ");
